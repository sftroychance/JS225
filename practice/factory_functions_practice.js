...
// - each object carries around its own copy of all the properties and methods
// - you can't interrogate the resultant object to know how it was created or what 'type' it is; you would have to create some external way to identify 'type'.

// (2)
// Rewrite the code below to use object-literal syntax to generate the returned
// object:
...
function createInvoice(services = {}) {
  const phoneDefault = 3000;
  const internetDefault = 5500;

  return {
    phone: services.phone || phoneDefault,
    internet: services.internet || internetDefault,
    total() {
...
// Your code should work with the given code below.
